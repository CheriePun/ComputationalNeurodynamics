...
def Connect2LQIF(N0, N1):
  ...
  r = rn.rand(N0)
  net.layer[0].N = N0
  net.layer[0].R = 1.0 * np.ones(N0)
  net.layer[0].tau = 5 * np.ones(N0)
  net.layer[0].vr = -65 + 15*(r**2)
  net.layer[0].vc = -50 + 6*(r**2)
  net.layer[0].a = 0.2 * np.ones(N0)
  
  # Layer 1 (regular spiking)
  r = rn.rand(N1)
  net.layer[1].N = N1
  net.layer[1].R = 1.0 * np.ones(N1)
  net.layer[1].tau = 5 * np.ones(N1)
  net.layer[1].vr = -65 + 15*(r**2)
  net.layer[1].vc = -50 + 6*(r**2)
  net.layer[1].a = 0.2 * np.ones(N1)
